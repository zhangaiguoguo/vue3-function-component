...
export enum EffectQueueFlag {
  USE_STATE = 0b00000000000001,
  USE_EFFECT = 0b00000000000010,
  USE_MEMO = 0b00000000000100,
  USE_CALLBACK = 0b00000000001000,
  USE_REDUCER = 0b00000000010000,
  USE_REF = 0b00000000100000,
  USE_LAYOUT_EFFECT = 0b00000001000000,
  USE_TRANSITION = 0b00000010000000,
